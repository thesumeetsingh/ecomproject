...
const Navbar = ({ onSelectCategory, onSearch }) => {
  ...
  //         response = await axios.get(`${import.meta.env.VITE_API_URL}/api/products/search?id=${value}`);
  //       } else {
  //         // Input is not a number, search by keyword
  //         response = await axios.get(`${import.meta.env.VITE_API_URL}/api/products/search?keyword=${value}`);
  //       }
      ...
      <header>
        <nav className="navbar navbar-expand-lg fixed-top">
          <div className="container-fluid">
            <a className="navbar-brand" href="https://github.com/thesumeetsingh/ecomproject">
              E-Com
            </a>
            <button
